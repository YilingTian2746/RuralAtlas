...
cb_palette <- c("#999999", "#E69F00","356B4E9","009E73",
                "#F0E442","3D55E00","#CC79A7")
...
Note: \
1.This graph excludes PR; since we don't have information on education levels on the state level.\
2.Several counties of AK and HI have missing values on unemployment rate; however, since we are interested in finding possible trend between unemployment rate and poverty rate on the state level, the missing values will not significantly affect our result.\
...
Without a doubt, we cannot assure the relationship between Unemployment and Education Levels; therefore, in order to verify the dependency relation discussed above, we need to do further regression analysis.\
...
Note: \
1.Several counties of AK, NM and AV have missing values; however, since we are interested in finding possible trend between unemployment rate and occupational industry on the state level, the missing values will not significantly affect our result.\
...
Without a doubt, we cannot assure the relationship between unemployment and occupational industry proportion; therefore, in order to verify the dependency relation discussed above, we need to do further regression analysis.\
