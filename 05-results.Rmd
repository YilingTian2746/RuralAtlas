...
UnempRate_data[UnempRate_data$county_fips == '15005', ]
...
Poverty_data <- rad_merge[2:nrows, c(1,2,78)] 
...
Income_data <- rad_merge[2:nrows, c(1, 2, 76)] 
...
### Dependency relation between Unemployment Rate and Occupation Insdustries
```{r, fig.width=12}
